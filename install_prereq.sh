...
then
	sudo -H pip3 install --upgrade $PY3_DEPENDENCIES
	sudo -H pip2 install --upgrade $PY2_DEPENDENCIES
else
	sudo -H python3 -m pip install --upgrade $PY3_DEPENDENCIES
	sudo -H python2 -m pip install --upgrade $PY2_DEPENDENCIES
fi
